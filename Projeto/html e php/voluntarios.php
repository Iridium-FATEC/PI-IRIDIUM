...
<body>
    ...
    <div>
        <form method="POST" action="processa.php">
            <fieldset>
                <p>Tipo de Voluntário:<input type="text" name="vvoluntario" id="cNome" size="25" maxlength="70" placeholder="Ex: dar aulas, monitoria, atividades recreativas, dentre outros"/></p>
                <p>Nome:<input type="text" name="vnome" id="cNome" size="25" maxlength="70" placeholder="Nome Completo"/></p>
                <p>CPF:<input type="text" name="vcpf" id="ccpf" size="14    " maxlength="70" placeholder="EX: 54362474214"/></p>
                <p>Email de contato:<input type="text" name="vemail" id="cMail" size="25" maxlength="70" placeholder="Example@gmail.com"/></p>
